...
const Login = () => {
  ...
  const handlePasswordResetRequest = async () => {
    ...
    const result = await response.text();
    setResetToken(result.includes("Password reset token: ") ? result.split(": ")[1] : "");
    alert(result);
  };
    ...
    <div className="login" id="rcorners2">
      <form onSubmit={handleSubmit}>
        ...
        <div className="imgcontainer">
          <img src="https://img.freepik.com/free-vector/happy-cute-girl-chef-holding-bowl-with-whisk-banner-logo-cartoon-art-illustration_56104-786.jpg?semt=ais_hybrid" alt="Avatar" className="avatar" />
        </div>
        ...
        <div className="container">
          ...
          <div>
            <p onClick={() => setIsResettingPassword(true)} style={{ cursor: "pointer", color: "blue" }}>
              Forgot Password?
            </p>
          </div>
